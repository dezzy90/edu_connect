...
export default function StudentsCreate({ schools, classes, sections, levels, options, isSuper, admin }: Props) {
    ...
    // Fetch sections when school changes
    useEffect(() => {
        if (data.school_id) {
            setLoadingSections(true);
            axios.get('/api/cascading/sections', {
    ...
    // Fetch options when section changes
    useEffect(() => {
        if (data.section_id) {
            setLoadingOptions(true);
            axios.get('/api/cascading/options', {
    ...
    // Fetch levels when option changes
    useEffect(() => {
        if (data.option_id) {
            setLoadingLevels(true);
            axios.get('/api/cascading/levels', {
    ...
    useEffect(() => {
        if (data.level_id) {
            ...
            axios.get('/api/cascading/classes', {
                            ...
                            <CardContent className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <select
                                        ...
                                        disabled={!data.school_id || loadingSections}
                                        className="w-full px-3 py-2 border border-input bg-background rounded-md text-sm disabled:opacity-50 disabled:cursor-not-allowed"
                                    >
                                        <option value="">
                                            {!data.school_id 
                                                ? "Select school first" 
                                ...
                                <div className="space-y-2">
                                    ...
                                    <select
                                        ...
                                        disabled={!data.section_id || loadingOptions}
                                        className="w-full px-3 py-2 border border-input bg-background rounded-md text-sm disabled:opacity-50 disabled:cursor-not-allowed"
                                    >
                                        <option value="">
                                            {!data.section_id 
                                ...
                                <div className="space-y-2">
                                    ...
                                    <select
                                        ...
                                        disabled={!data.option_id || loadingLevels}
                                        className="w-full px-3 py-2 border border-input bg-background rounded-md text-sm disabled:opacity-50 disabled:cursor-not-allowed"
                                    >
                                        <option value="">
                                            {!data.option_id 
                                ...
                                <div className="space-y-2">
                                    ...
                                    <select
                                        ...
                                        disabled={!data.level_id || loadingClasses}
                                        className="w-full px-3 py-2 border border-input bg-background rounded-md text-sm disabled:opacity-50 disabled:cursor-not-allowed"
                                        required
                                    >
                                        <option value="">
